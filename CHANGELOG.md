...
## [1.39.0](https://github.com/wrighterase/emp3r0r/compare/v1.38.3...v1.39.0) (2024-11-08)


### Features

* add `ssh_harvester` ([6a557e1](https://github.com/wrighterase/emp3r0r/commit/6a557e192c45799a6b0f84795119e3fd18e4ac9b))
* add elvsh as default shell ([12eba72](https://github.com/wrighterase/emp3r0r/commit/12eba72ec21d7bb3b88b8b924a00731705d5ea51))
* add mimikatz (no AV evasion) ([f1a44fc](https://github.com/wrighterase/emp3r0r/commit/f1a44fcf74303d56fd89005e9233476807960d26))
* C2 relay via SSH ([522b6b3](https://github.com/wrighterase/emp3r0r/commit/522b6b37779d34d674ed4bc47842692ef944875f))
* deprecate `gen_agent` cmd in favor of `use gen_agent` module ([add0a7e](https://github.com/wrighterase/emp3r0r/commit/add0a7eb1b0a0ed916a4b298c4712661421783e9))
* ditch static magic string for packer ([f7edcc6](https://github.com/wrighterase/emp3r0r/commit/f7edcc6c6eecc3cb5d9ff2dbffc3b739efefe029))
* hide PIDs and files using loader.so ([c54c5f5](https://github.com/wrighterase/emp3r0r/commit/c54c5f53522c5c93270c5189d6f54d30ee9a050c))
* implement basic stager (linux/bash) ([9f4f9ba](https://github.com/wrighterase/emp3r0r/commit/9f4f9baed0e85096c9950a7fa219ab3eadeb0fb9))
* improve agent binary structure ([fd76e5c](https://github.com/wrighterase/emp3r0r/commit/fd76e5cd3bb8efcd2b017ca24ada5d432e070b0c))
* inject arbitrary shared lib ([f4a0c1c](https://github.com/wrighterase/emp3r0r/commit/f4a0c1c85ddec6f47c5f64dda5183c6dac1edba0))
* module help for `gen_agent` ([ea3cfe7](https://github.com/wrighterase/emp3r0r/commit/ea3cfe7c7c8eac444d63662f894b9ef9c016f05b))
* multi-arch support ([40bc0fe](https://github.com/wrighterase/emp3r0r/commit/40bc0fe9e123eac5842a32c6af5d3facc56c0ebf))
* pack agent binary by default (linux) ([4811229](https://github.com/wrighterase/emp3r0r/commit/4811229b8ca75a13c6ba691e0a432d4bdbad03aa))
* reduce size of `vaccine` ([c560dbb](https://github.com/wrighterase/emp3r0r/commit/c560dbb5c93bfda418b8e07baf514c788b4919de))
* remove shell pane ([86851d2](https://github.com/wrighterase/emp3r0r/commit/86851d2a55000f50a3c149b349032f0dc199a577))
* revamp `lpe_helper` ([94d3601](https://github.com/wrighterase/emp3r0r/commit/94d3601ce45baa4df8af019a03e5f2d46ab056d1))
* support DLL agent stub (`amd64` only) ([eda0e94](https://github.com/wrighterase/emp3r0r/commit/eda0e94cc30f82bc80b6e4dbbcddffded8da4265))
* support in-memory ps1 modules ([959517b](https://github.com/wrighterase/emp3r0r/commit/959517bf43c547c9fdaad503a1ce81343048d017))
* switch to utls to defeat JA3 fingerprinting ([b9bf54f](https://github.com/wrighterase/emp3r0r/commit/b9bf54f1a33389d64e658c73e04af5a4412b1da6))
* UDP port mapping ([c2b6b32](https://github.com/wrighterase/emp3r0r/commit/c2b6b32b2f0b8ee19d7ea7fce5fe199fdac94711))
* upgrade tmux config ([d5fc0d0](https://github.com/wrighterase/emp3r0r/commit/d5fc0d0edcf944c2089071b855f12d56b62edbe3))
* use AES-CBC mode to support tiny-AES ([72c4cea](https://github.com/wrighterase/emp3r0r/commit/72c4cea4bf2d6dc178b55531c58f6f632a717765))


### Bug Fixes

* [#152](https://github.com/wrighterase/emp3r0r/issues/152): drop extension name for Linux agent binary ([79dfba2](https://github.com/wrighterase/emp3r0r/commit/79dfba272360069ac4305891857b71b7c6655343))
* [#192](https://github.com/wrighterase/emp3r0r/issues/192) ([18e2a9b](https://github.com/wrighterase/emp3r0r/commit/18e2a9bc1866efb5cc39e3951a0a45d68a4863b0))
* [#196](https://github.com/wrighterase/emp3r0r/issues/196) ([1ec35ca](https://github.com/wrighterase/emp3r0r/commit/1ec35ca4f6e3d54800832199e2bb3b8b806f93b4))
* [#199](https://github.com/wrighterase/emp3r0r/issues/199) ([7591681](https://github.com/wrighterase/emp3r0r/commit/759168139a5e25b2d2199182d14f22c5b4041e13))
* [#201](https://github.com/wrighterase/emp3r0r/issues/201), use winpty to support ConPTY shell on all Windows versions ([dfc54c0](https://github.com/wrighterase/emp3r0r/commit/dfc54c0a11f8a976928b2e39f8369f954d688e2d))
* [#203](https://github.com/wrighterase/emp3r0r/issues/203) ([972664a](https://github.com/wrighterase/emp3r0r/commit/972664ae8597ea346e2f44525d4a17b14c144fdd))
* [#210](https://github.com/wrighterase/emp3r0r/issues/210) ([f926d83](https://github.com/wrighterase/emp3r0r/commit/f926d830ed1719827e1a3c0f919d5d12a05f791d))
* [#219](https://github.com/wrighterase/emp3r0r/issues/219) ([f0b414a](https://github.com/wrighterase/emp3r0r/commit/f0b414a2147037ab3c248934dc5c3c5b9904949a))
* [#236](https://github.com/wrighterase/emp3r0r/issues/236) ([84e1fda](https://github.com/wrighterase/emp3r0r/commit/84e1fdacb0320d7c83cec7dea1a604749919c82f))
* [#244](https://github.com/wrighterase/emp3r0r/issues/244) ([50a0221](https://github.com/wrighterase/emp3r0r/commit/50a0221c614c831f426086a5a15f914fcb70cee6))
* [#246](https://github.com/wrighterase/emp3r0r/issues/246) ([da2bfd1](https://github.com/wrighterase/emp3r0r/commit/da2bfd11729a729e8d4925862ab9b947c9795356))
* [#248](https://github.com/wrighterase/emp3r0r/issues/248) ([e89155d](https://github.com/wrighterase/emp3r0r/commit/e89155d2c14a73ed7d834be214ced9d0ada37227))
* [#250](https://github.com/wrighterase/emp3r0r/issues/250) ([c01340d](https://github.com/wrighterase/emp3r0r/commit/c01340d2651ce5ab4260b1955b23fac6fbf1c57f))
* [#250](https://github.com/wrighterase/emp3r0r/issues/250) ([99b2fb0](https://github.com/wrighterase/emp3r0r/commit/99b2fb04bb33a0c4f62ac7a8d6dc08192259a0da))
* [#253](https://github.com/wrighterase/emp3r0r/issues/253) ([2ebb6f4](https://github.com/wrighterase/emp3r0r/commit/2ebb6f42434b38cc458fa6b2a7ec1a72ec3c18ce))
* [#264](https://github.com/wrighterase/emp3r0r/issues/264) add option to disable timeout in proxy altogether ([e8b31e5](https://github.com/wrighterase/emp3r0r/commit/e8b31e59d5d439e1dff143a541e8c0a67d0141ec))
* [#264](https://github.com/wrighterase/emp3r0r/issues/264) disable timeout and leave cleanup job to the OS ([d3cea97](https://github.com/wrighterase/emp3r0r/commit/d3cea97539474e779d1a03c1f7cd805c8e84893c))
* [#264](https://github.com/wrighterase/emp3r0r/issues/264) increase timeout to 2 minutes ([cc7034d](https://github.com/wrighterase/emp3r0r/commit/cc7034d3914295ccf55fffa87e9269b7126b6d3d))
* [#292](https://github.com/wrighterase/emp3r0r/issues/292) DLL agent ([dddd442](https://github.com/wrighterase/emp3r0r/commit/dddd4421f9f103d31b2f80acb7ff4faf1fe76014))
* [#318](https://github.com/wrighterase/emp3r0r/issues/318) ([ac2a682](https://github.com/wrighterase/emp3r0r/commit/ac2a682b224d43382e7ac48320b7b3450547955c))
* [#5](https://github.com/wrighterase/emp3r0r/issues/5)  `fork` not supported on `arm64` ([d962876](https://github.com/wrighterase/emp3r0r/commit/d9628769f889c0ab8848f60daaf2c8b3065d0465))
* /bin/bash doesnt exist on some systems ([794887f](https://github.com/wrighterase/emp3r0r/commit/794887fe8836f3cb0a1dc5570003f5014b1de91c))
* `__libc_dlopen_mode` not found ([322d071](https://github.com/wrighterase/emp3r0r/commit/322d0719fcb9182b5f5a94e071ad367e9d585eec))
* `-connect_relay` unable to recovery SSH session ([8bde2fb](https://github.com/wrighterase/emp3r0r/commit/8bde2fbc7aa9b215e8b0cf8f3fc6a85f56b3e964))
* `-gencert` refuses to work when `emp3r0r.json` not found ([f100936](https://github.com/wrighterase/emp3r0r/commit/f100936ef288eadb6045c67bc5d1c165fa0f9c5b))
* `bring2cc` fails to connect configure SOCKS5 proxy ([d11c8f0](https://github.com/wrighterase/emp3r0r/commit/d11c8f08c802d9a9662e603f6a6611e751c0d0a1))
* `bring2cc` should start SOCKS5 server automatically ([48b7311](https://github.com/wrighterase/emp3r0r/commit/48b7311dc3096e2cd9e3f9047cd64b3a03e1b48b))
* `elvsh` shell cant start due to missing agent binary ([c090e08](https://github.com/wrighterase/emp3r0r/commit/c090e0854e4ccfeb462728e54dd1ef73e186ad50))
* `elvsh` shell for windows ([e4d97d8](https://github.com/wrighterase/emp3r0r/commit/e4d97d8f9c5cc886efa782879377d754c2f2f911))
* `FileBaseName` needs to strip `/` ([4eca34b](https://github.com/wrighterase/emp3r0r/commit/4eca34b651c01abf61c1b5a64221a78146516136))
* `gen_agent` should abort when OS choice is invalid ([a8c2142](https://github.com/wrighterase/emp3r0r/commit/a8c21423e9d4ef672ac163575f17b2d54fde550b))
* `get_persistence` causes unalias error ([43dc8ee](https://github.com/wrighterase/emp3r0r/commit/43dc8ee181e5194b07454b466a48c49abae2b494))
* `get_persistence` result readability issue ([438289f](https://github.com/wrighterase/emp3r0r/commit/438289f6cb7081860f26a76ade301b48a1e76d03))
* `get_persistence`: fix `profiles` method ([7a1858e](https://github.com/wrighterase/emp3r0r/commit/7a1858e4a848d97153d0d4bc80ab6638f1dcd4cf))
* `go-console` fails to start winpty ([e7e2939](https://github.com/wrighterase/emp3r0r/commit/e7e2939b572053e44d3b41c5cc6bd8635b7958f1))
* `grab` creates on-disk file even if no path is specified ([dfbf640](https://github.com/wrighterase/emp3r0r/commit/dfbf640276bc46819df6b526421ae1ea34ba2ec5))
* `inject_loader` fails to launch agent ([77c445b](https://github.com/wrighterase/emp3r0r/commit/77c445b6b07d0a2cacda0c672388d0830a620d70))
* `interactive_shell` cmd env ([fc386ab](https://github.com/wrighterase/emp3r0r/commit/fc386ab61ca3cad1b5f788c9c39f56363d04b6f5))
* `interactive_shell` fails to execute due to empty argv ([5b7e397](https://github.com/wrighterase/emp3r0r/commit/5b7e397b1582ce5749ce6fee6696359153354960))
* `IsAgentAlive` stuck ([2792bf3](https://github.com/wrighterase/emp3r0r/commit/2792bf33124d573f95c91a73e27a6aa9e69a389e))
* `label` by tag not working ([131d84e](https://github.com/wrighterase/emp3r0r/commit/131d84e1f1aa2e888978adaedd6876b61cd9e2ce))
* `linux/bash` stager serving: incorrect path ([0f1b33f](https://github.com/wrighterase/emp3r0r/commit/0f1b33fb1ebdd4d416e2d0759f407ac8cfeba72f))
* `lpe_linpeas` unable to run ([a32187f](https://github.com/wrighterase/emp3r0r/commit/a32187f7bd776a7e364405330bfd304964cf1855))
* `lpe_winpeas` for Windows LPE ([a79f8a2](https://github.com/wrighterase/emp3r0r/commit/a79f8a2b4e260dcbaa71465214acd5cd90c217af))
* `passProxy` proxy URL parsing error ([957395e](https://github.com/wrighterase/emp3r0r/commit/957395edc369dbf51463af11d061c2421a20343d))
* `PATH` env should contain `sbin` paths ([4036968](https://github.com/wrighterase/emp3r0r/commit/40369682981190dad41e1080e568fd0fa1979a17))
* `profiles` persistence method ([6321b3c](https://github.com/wrighterase/emp3r0r/commit/6321b3cc27e3efe32442a68b67fadd89b67dae24))
* `run_as_daemon` should always be enabled ([11a3979](https://github.com/wrighterase/emp3r0r/commit/11a39793e16564ced29907bf5439ebca723177fd))
* `split-window -l` needs `%` to specify percentage ([266f195](https://github.com/wrighterase/emp3r0r/commit/266f195a6ac932ea9b3000b027dc668c3008160f))
* `split-window -p &lt;size&gt;` has been deprecated in tmux newer versions ([d625d87](https://github.com/wrighterase/emp3r0r/commit/d625d87d0ca2d2f7b4e0bf69e4decae06da037ec))
* `unarchive` secure path validation ([ce61818](https://github.com/wrighterase/emp3r0r/commit/ce618182704c3f0f92974163c9fba20f2927a119))
* `Unarchive` with `archiver/v4` implementation ([fc96304](https://github.com/wrighterase/emp3r0r/commit/fc96304c4524d14242bab9ac7c9251cbda8573f7))
* `use` command should show more info about the selected module ([e04dc5b](https://github.com/wrighterase/emp3r0r/commit/e04dc5b246b822fc9fb8b9b5ab82ba4d15d37275))
* `VERBOSE=true` not working ([b7894c4](https://github.com/wrighterase/emp3r0r/commit/b7894c463e7a178ebc6b8cc51f116a4e0afa594d))
* 1. option to disable NCSI check 2. upgrade deps ([5a14b7a](https://github.com/wrighterase/emp3r0r/commit/5a14b7a741e905a64c3d3b05db0643bd2ce0b840))
* 254 ([a9f3674](https://github.com/wrighterase/emp3r0r/commit/a9f36743fcc4c2c8e5085f9318c335280eb361fd))
* add `config.json` for `mimikatz` module ([a99139c](https://github.com/wrighterase/emp3r0r/commit/a99139cf819cad3709c46b93b2d499f2b7027849))
* add `libexpat.so.1` as python needs it ([76a9acf](https://github.com/wrighterase/emp3r0r/commit/76a9acf00c2391735313f57808a85673bd2a22fb))
* add help to `get_persistence` ([a5a9879](https://github.com/wrighterase/emp3r0r/commit/a5a98794c0955f44568e9e68806db123b49603de))
* add instructions ([c051806](https://github.com/wrighterase/emp3r0r/commit/c051806a6c042501658623b26ade3d7995b6baf0))
* add option to uninstall ([e1a4e0d](https://github.com/wrighterase/emp3r0r/commit/e1a4e0d92aa9a7a9727bf0b5df741869e959c301))
* AES encryption: use GCM for authentication ([e713898](https://github.com/wrighterase/emp3r0r/commit/e713898da991df9306a1ac5ce133aa93f913b6e8))
* agent aborts connection (Windows) ([8c73193](https://github.com/wrighterase/emp3r0r/commit/8c731935b440ff4828ed4aa23bc8ee8bd6148f31))
* agent aborts connection when C2 is unreachable ([def1b2a](https://github.com/wrighterase/emp3r0r/commit/def1b2a453931dc8e2490749b649720b6eedb289))
* agent authentication ([a2386e2](https://github.com/wrighterase/emp3r0r/commit/a2386e2c0acc5305e4e65f0bcd244b12b15fc778))
* agent fails to connect on first try ([1675de9](https://github.com/wrighterase/emp3r0r/commit/1675de98b715d603ca40d54ab26bb3d2bfe6f896))
* agent root directory missing `/` ([a3ef9b4](https://github.com/wrighterase/emp3r0r/commit/a3ef9b49312b995b9576e9a60d4f91a6ba721e33))
* agent root naming in Windows ([ff6ee40](https://github.com/wrighterase/emp3r0r/commit/ff6ee401658508b57e3daaf1b2059de295153757))
* agent side SOCKS5 server lacks authentication ([67cba96](https://github.com/wrighterase/emp3r0r/commit/67cba9613a95b1181de439adfbad39eb9b9f9f20))
* agent system info pane not being updated ([5e9a8ab](https://github.com/wrighterase/emp3r0r/commit/5e9a8abb2755076e2fdf80a62517ad2d933ab91a))
* agent wait queue ([f4e45f7](https://github.com/wrighterase/emp3r0r/commit/f4e45f7bd5b6d482c57fade7bfe3404773fc3255))
* agent won't run when packed by upx ([4d35ef9](https://github.com/wrighterase/emp3r0r/commit/4d35ef9d0fef31aa2fbadbffb426319c43618997))
* argv spoofing only works with long argv0 ([0f322bf](https://github.com/wrighterase/emp3r0r/commit/0f322bf12f3a9ff84f311bc46964ba29303ce3a9))
* auto proxy broken ([7b04571](https://github.com/wrighterase/emp3r0r/commit/7b045715213229b2afb10d9ee71416bbefd29b31))
* auto-complete `gen_agent` module options ([71e7d79](https://github.com/wrighterase/emp3r0r/commit/71e7d79fc5621db731d53a6f205143d0ea889792))
* auto-modify cmdline args (linux) ([b4ca3a3](https://github.com/wrighterase/emp3r0r/commit/b4ca3a3a06df7d0740d55845356eb8b86543943a))
* auto-resize console buffer on elvsh start, to match C2 terminal size ([71167e4](https://github.com/wrighterase/emp3r0r/commit/71167e487ecccbf84522b73c430e4271a5afc847))
* auto-updating hide_pid list ([7a2d822](https://github.com/wrighterase/emp3r0r/commit/7a2d8227f23a81558f82c345a5f1e4ceeb21d5b9))
* bash stager unable to execute agent ([f406100](https://github.com/wrighterase/emp3r0r/commit/f4061006fe50b79730e186e204cc2a20611416cc))
* be silent when started by loader.so ([4113d3d](https://github.com/wrighterase/emp3r0r/commit/4113d3d675669be21fa5d3c7a54523f36ffd6d6a))
* BlackArch PKGBUILD ([5cc5d1f](https://github.com/wrighterase/emp3r0r/commit/5cc5d1ff1a42cd92d85307abc098e4fb7e931128))
* build issue ([67eb322](https://github.com/wrighterase/emp3r0r/commit/67eb3222530d94b80340efae2b0db50f1d82031e))
* build: switch to `zstd` ([d7e1eeb](https://github.com/wrighterase/emp3r0r/commit/d7e1eeb8d9b02c2a6e71cb8e4805e05fba8f657b))
* C2 relay client ([7e121d6](https://github.com/wrighterase/emp3r0r/commit/7e121d664b2cc9eaaeb2cf4b316f11e7c25d29e1))
* C2 relay: C2 service not running ([4a26931](https://github.com/wrighterase/emp3r0r/commit/4a2693135df576c5b86f7c6c0197069d0c772d69))
* c2 server no longer needs to be manually restarted when new c2 name is added ([8d9a81b](https://github.com/wrighterase/emp3r0r/commit/8d9a81b8c7caebe44530f950e53182a353796955))
* CC unable to detect existing instance ([15e2940](https://github.com/wrighterase/emp3r0r/commit/15e2940c1fd379eb2666bd82c2b69f44f2d78519))
* change process name affects loader.so ([83c1109](https://github.com/wrighterase/emp3r0r/commit/83c1109adea87c8732d4bdfd637b6e13c193096b))
* check if an ELF is static ([d574330](https://github.com/wrighterase/emp3r0r/commit/d574330c7d212a634de1e24ac29702a4df2e26cd))
* cleanup queue when there are too many waiting ([3933766](https://github.com/wrighterase/emp3r0r/commit/39337667d7557ab4905ae63947626635e479c3ff))
* cleanup work for stager, python2, obfuscate agent binary ([e91f583](https://github.com/wrighterase/emp3r0r/commit/e91f5832007be6c5c1cc391aa52e172f652fdfc6))
* command time msg should exclude built-in cmds ([e6a5d2d](https://github.com/wrighterase/emp3r0r/commit/e6a5d2d3c34beb5330522f5dfe2419d862b413dd))
* concurrent map access in handshake thread ([1adbb47](https://github.com/wrighterase/emp3r0r/commit/1adbb47df7200b80eceb11e9c3fd11eddfcd541d))
* confusion on `reverse_proxy` feature, see [#190](https://github.com/wrighterase/emp3r0r/issues/190) ([b6425f0](https://github.com/wrighterase/emp3r0r/commit/b6425f0b7a4dea1ac25b46055325c6f32d620c49))
* connectivity check should connect to C2 using uTLS ([8b746c5](https://github.com/wrighterase/emp3r0r/commit/8b746c5bf38e6300362e8b42f750c1f1e83e0fb9))
* daemonizing issues (argv modification fails) ([d005862](https://github.com/wrighterase/emp3r0r/commit/d00586280befe80f007b749bb68362018a1848e8))
* damonize and be silent when started by persistence script ([e14f3eb](https://github.com/wrighterase/emp3r0r/commit/e14f3eb94f81ddb24fbb3e268c5f7dfc66a9630e))
* delete orphaned functions ([7b744c1](https://github.com/wrighterase/emp3r0r/commit/7b744c11fb2151c27aa895bf650286aaf52a7aa1))
* deprecate MS NCSI as it doesn't support HTTPS ([62f2115](https://github.com/wrighterase/emp3r0r/commit/62f21154b29daddfb944670fd334a5b18ce2f9c6))
* disable agent logging by default ([687230c](https://github.com/wrighterase/emp3r0r/commit/687230c260b958c05e214f6452ccec6dbd00dc77))
* disable console resizing for windows due to bugs ([19e7a88](https://github.com/wrighterase/emp3r0r/commit/19e7a887e9ae91c1690e895f7cfcab184afbad76))
* disable sysinfo warnings ([e7e07a2](https://github.com/wrighterase/emp3r0r/commit/e7e07a2c86fcb84c500b0575f8551bf0ee907d88))
* do not attemp to hide without root ([b69f6b1](https://github.com/wrighterase/emp3r0r/commit/b69f6b116edce85c6185b33ba578c4e43361f8e4))
* do not delay when started by loader.so ([ca596e9](https://github.com/wrighterase/emp3r0r/commit/ca596e91ac4b8286bb9e7e0763b1deb785eae09e))
* do not overwrite backup ([ef0b058](https://github.com/wrighterase/emp3r0r/commit/ef0b05808e7f7cfaac51ceeb41575dadbcdad0dd))
* do not prompt for indicator text when it's disabled ([f6e8c62](https://github.com/wrighterase/emp3r0r/commit/f6e8c62b7f35e9cb90906be9c53b70cdb6be7186))
* don't install to all locations at once ([87f1ebb](https://github.com/wrighterase/emp3r0r/commit/87f1ebb7db801139dabf73cf2381a07fc7b6ebe3))
* DownloadViaCC has racing issue ([0d96ca8](https://github.com/wrighterase/emp3r0r/commit/0d96ca811de660b54a2379f8fa165984b29e18c6))
* dynamic prompt string not available after `CliAsk` or `CliYesNo` ([85e6eba](https://github.com/wrighterase/emp3r0r/commit/85e6ebac773f692bc91cfad7111ff6c575098475))
* elf loader unable to run emp3r0r ([d534359](https://github.com/wrighterase/emp3r0r/commit/d534359bfff417a04053ef0499f46d6a6d14c0e0))
* elvsh not working in ssh ([18773eb](https://github.com/wrighterase/emp3r0r/commit/18773eb290734939e186e2505a61eca07d511d70))
* elvsh should reuse sftp port ([8d8c99d](https://github.com/wrighterase/emp3r0r/commit/8d8c99d418484cba4e1da2c83d59c06bddb53b8b))
* elvsh: disable daemon ([96e5293](https://github.com/wrighterase/emp3r0r/commit/96e52934d2045f0ea8460539915e65040c088baf))
* embeded bash binary won't run, throws SEGV ([9fca402](https://github.com/wrighterase/emp3r0r/commit/9fca402d7eb52a76fb67d0bfa72057e196a38486))
* emp3r0r should exit after executing `-gencert` ([33edc36](https://github.com/wrighterase/emp3r0r/commit/33edc36d40861324a1dac6d980978d4150ceaca1))
* existing stager HTTP server should shutdown gracefully when a new stager is requested ([54005d8](https://github.com/wrighterase/emp3r0r/commit/54005d866dd53e85c799ce9c0008dba1b34e568e))
* file downloading progress might stuck at 100% when connection is interrupted ([37eabb2](https://github.com/wrighterase/emp3r0r/commit/37eabb2c51df158c5b42de37f90403e6be6cf912))
* go get -u ([8c90301](https://github.com/wrighterase/emp3r0r/commit/8c903010692512a0c9d740d9cc4436428ba5b90d))
* guadian shellcode unable to start agent ([9b81317](https://github.com/wrighterase/emp3r0r/commit/9b81317e8fedce49f562ea348386d07cd1121159))
* guardian shellcode: restore original binary ([a07b280](https://github.com/wrighterase/emp3r0r/commit/a07b28012cf82690a5000ab48ad7a1de990a51e4))
* handle AES decryption panic ([48e362e](https://github.com/wrighterase/emp3r0r/commit/48e362ef7de8c5d9a9c5bf80f2160921708ab059))
* help user understand how stager URL works ([71905e5](https://github.com/wrighterase/emp3r0r/commit/71905e57775d3c969cc6ce010aa9862af8610bc8))
* hidden_pids list gets overwritten ([fbf7c9c](https://github.com/wrighterase/emp3r0r/commit/fbf7c9c7b0963611d20b66481d8ad46b5337c0d0))
* igonore cmdline args when run as DLL ([4dd830e](https://github.com/wrighterase/emp3r0r/commit/4dd830e64920c9de9e35bff3e93e34cacd9b12f3))
* improve `PATH` handling on Windows/Linux ([dfcf572](https://github.com/wrighterase/emp3r0r/commit/dfcf572e07e0fd0b2fd5150959ec819be7a529e9))
* improve `upgrade_agent` ([a80f30b](https://github.com/wrighterase/emp3r0r/commit/a80f30b626c155735a9fcdda3c1a01dd06ce9474))
* improve file downloading feature ([2ec7f02](https://github.com/wrighterase/emp3r0r/commit/2ec7f0233868f181dbd819bd91323934475e4039))
* in-memory execution of ps1 modules ([d755ae6](https://github.com/wrighterase/emp3r0r/commit/d755ae67e0f7748af754fa88654d485f3108c787))
* inaccurate waitqueue count ([4eeacf6](https://github.com/wrighterase/emp3r0r/commit/4eeacf6af9dd5881fdf3311b59f67061bad9cac3))
* incomplete downloads cannot be resumed ([bbd57f9](https://github.com/wrighterase/emp3r0r/commit/bbd57f98e93fe44d37e339b0708e21742c8fa66d))
* incomplete file download percentage ([b4e120e](https://github.com/wrighterase/emp3r0r/commit/b4e120ef7650bbb2fa90df2aa617df8a48a06eea))
* inject_loader ([694fa31](https://github.com/wrighterase/emp3r0r/commit/694fa31148a970dc14859fbeb8386a5749ab4ca2))
* let user choose to inject existing lib/sc ([47fd9e6](https://github.com/wrighterase/emp3r0r/commit/47fd9e6439a99b4d01bb24ccf859a101b5b7cfd7))
* linux agent proc renaming when using `linux/bash` stager ([575777f](https://github.com/wrighterase/emp3r0r/commit/575777f1a51c22492fd61b5307680f59bf218b45))
* loader.so extraction error ([03fde3d](https://github.com/wrighterase/emp3r0r/commit/03fde3d51e2c0c00631f35fc21ed17a7820c9d6f))
* loader.so should return error for non-`amd64` ([4170414](https://github.com/wrighterase/emp3r0r/commit/41704149f3a511dda9beea668dc04968d7a9aa9c))
* loader.so unable to find exe due to malformed path name ([eec2dcc](https://github.com/wrighterase/emp3r0r/commit/eec2dcc05adecdb89bcb9321b2a4df0778dc95f6))
* log requests to stager HTTP server ([787344d](https://github.com/wrighterase/emp3r0r/commit/787344ddf4f14a222f8437b60b08572285bf0be4))
* long lines in `System Info` pane ([ef6f1d9](https://github.com/wrighterase/emp3r0r/commit/ef6f1d925abc8f2127c32f17b2d1ad3f68f6b32a))
* make bash command line look normal ([2315c96](https://github.com/wrighterase/emp3r0r/commit/2315c96f006619fc110dce5dae534ac541aeb426))
* make sure stdin closes ([a328ea8](https://github.com/wrighterase/emp3r0r/commit/a328ea8cf1acbbfe67cd4874f570f2997725b64a))
* mimikatz's documentation ([3741b36](https://github.com/wrighterase/emp3r0r/commit/3741b362e9c73cac643a65eb65de54e13989843d))
* mips builds missing ([dd9eed5](https://github.com/wrighterase/emp3r0r/commit/dd9eed5922f0620069a2dc467f4a5e6075fa93b6))
* module unpack using xz ([177eaa2](https://github.com/wrighterase/emp3r0r/commit/177eaa2d6a70a62ad9055c9f925a71b03afc7eb2))
* multi-arch build, cc crash on start ([fb04c2c](https://github.com/wrighterase/emp3r0r/commit/fb04c2cbe6b5800477bfa1c9a1bcfe40aa39951b))
* no error reported when `lpe_helper` fails ([39284ab](https://github.com/wrighterase/emp3r0r/commit/39284ab9645f8597d5962055d8a45e6ea198f751))
* no need to remove in python stager ([09c1c03](https://github.com/wrighterase/emp3r0r/commit/09c1c03f464961673d3a06ab82e16c5491fe8144))
* optimize `profiles` persistence ([963ba13](https://github.com/wrighterase/emp3r0r/commit/963ba13e04f0c1a8f97d985f25c82bb9443dfbcf))
* outdated loader.so ([3ee239e](https://github.com/wrighterase/emp3r0r/commit/3ee239e560aeac6f7a07f20d719f05a939f98d05))
* pack modules with xz, reduce size even more ([955b6bd](https://github.com/wrighterase/emp3r0r/commit/955b6bdabef121266befe952e0b3e143b6273a58))
* panic on HTTP2 server ([45d0ff7](https://github.com/wrighterase/emp3r0r/commit/45d0ff786581c8078db789c0b8493620131878ee))
* panic: nil ref when UDP port_fwd session dies ([0cd3746](https://github.com/wrighterase/emp3r0r/commit/0cd3746e9eba734f0e87d7a84e9317142f9036a3))
* patch static ELFs and `patchelf` itself ([286ddfb](https://github.com/wrighterase/emp3r0r/commit/286ddfbabd076e91b398d02429a10a5fe5d34d2f))
* permission error for Linux modules ([bf0ab59](https://github.com/wrighterase/emp3r0r/commit/bf0ab5983dcada63541bccedddecb06a3095fcd5))
* persistence using profiles ([#260](https://github.com/wrighterase/emp3r0r/issues/260)) ([409f51c](https://github.com/wrighterase/emp3r0r/commit/409f51cbf16ca21fee455f2aa347fdb750b9fd1d))
* portfwd timeout implementation ([b22e91d](https://github.com/wrighterase/emp3r0r/commit/b22e91d7898530197bdd1602235d5728ef6ea3da))
* prefer custom bash binary ([9c13feb](https://github.com/wrighterase/emp3r0r/commit/9c13febeed5556691ca10b4d7d551110dfa302ad))
* process renaming can't start new process ([2ca3fc1](https://github.com/wrighterase/emp3r0r/commit/2ca3fc1c0714fceb28da7712ec6f6c51034a12ee))
* python stager not working and not secure ([4962cd8](https://github.com/wrighterase/emp3r0r/commit/4962cd872a27fbd1dedb5484ec9d7b697d398241))
* re-implement kcp C2 based on kcptun, use single UDP connection ([331b857](https://github.com/wrighterase/emp3r0r/commit/331b8575dbd765d822021ec928489a1fae55f83e))
* reduce CPU load ([2f5ed34](https://github.com/wrighterase/emp3r0r/commit/2f5ed34f72ca41d44d2e08a8747307a9ba631fa3))
* reduce noisy logging for debug level 2 ([56b3d9a](https://github.com/wrighterase/emp3r0r/commit/56b3d9a94a02c957d796d43d1e04e4456742373f))
* refactor: merge Linux/Windows agent code ([db70d70](https://github.com/wrighterase/emp3r0r/commit/db70d702dad6e7033310b9c7cbecd57a5bc2aed7))
* release-please: switch to `tar.zst` ([d430c7d](https://github.com/wrighterase/emp3r0r/commit/d430c7d2fe05f334c51af270280e99a2c9c624dd))
* remove `archiver/v3` ([#318](https://github.com/wrighterase/emp3r0r/issues/318)) ([03e6367](https://github.com/wrighterase/emp3r0r/commit/03e6367988fd10369f8ddd4d8b0d8dffa82b3eec))
* remove `injector` in `get_persistence`, etc ([f7e04b1](https://github.com/wrighterase/emp3r0r/commit/f7e04b17e307c936108cc1820fe0f1bf4991b585))
* remove `vim` command in favor of `file_manager` ([6164d95](https://github.com/wrighterase/emp3r0r/commit/6164d9599f6a750ae4c459e32898644ccd8831d7))
* remove packer ([713e725](https://github.com/wrighterase/emp3r0r/commit/713e725d0bcb285ac69efcc17c1ecee113569dcd))
* remove redundant cmdline args ([a2ee4f1](https://github.com/wrighterase/emp3r0r/commit/a2ee4f1251185c700df0556091fc88555cd5ae0f))
* remove unnecessary colors in "system info" ([ca14ba1](https://github.com/wrighterase/emp3r0r/commit/ca14ba1c11a572de354ca1a74ea7247a6e0db10f))
* report arp cache ([658c823](https://github.com/wrighterase/emp3r0r/commit/658c823f0ca19582a1d0d934e57e7979c76743e3))
* req verification for `DownloadViaCC` ([e40db33](https://github.com/wrighterase/emp3r0r/commit/e40db33f985beb572758a18a3b9d4d010bea6f64))
* run modules without specifying target ([8630a24](https://github.com/wrighterase/emp3r0r/commit/8630a24adce278853cff2a01657c19c37dfb4c58))
* run path error ([773ee53](https://github.com/wrighterase/emp3r0r/commit/773ee530f3a24868e964a56adff5e347d50da2b9))
* scripts unable to run ([32a808a](https://github.com/wrighterase/emp3r0r/commit/32a808aa37a646b1a64e60fcfb347f892ccbd4fe))
* security issue in `archiver` ([ffd261e](https://github.com/wrighterase/emp3r0r/commit/ffd261e610ddbc77fcaf9c197b5c5d8fc7d1f22f))
* sftp pane not opening ([82e2fc5](https://github.com/wrighterase/emp3r0r/commit/82e2fc5269e3c137eac7e2b60e5f27ce4cfa5210))
* shell pane unable to start when run from loader.so ([2b6d3ea](https://github.com/wrighterase/emp3r0r/commit/2b6d3ea5b10085cdca82f9f4adfd516767463c10))
* show C2 address in agent system info ([7032d34](https://github.com/wrighterase/emp3r0r/commit/7032d34c0d546264335664048213d0a9767010ec))
* some crypto functions ([e425081](https://github.com/wrighterase/emp3r0r/commit/e4250812b50ba6ce252a43dc405c529ff0584767))
* some traffic bypasses shadowsocks/kcp proxy ([a45b14c](https://github.com/wrighterase/emp3r0r/commit/a45b14cc44e48ca0b50a3ee6b844167a8741f1fd))
* sometimes CA cert is not added to agent config ([a003cd0](https://github.com/wrighterase/emp3r0r/commit/a003cd07de64f9f22ebd8ddd49b3fcfdb88802d4))
* sort hidden_pids list ([a63dcef](https://github.com/wrighterase/emp3r0r/commit/a63dcef6cd3db73d09d5d4a2e431221aafdae808))
* ssh C2 relay client should retry connection until SSH session is established ([966147b](https://github.com/wrighterase/emp3r0r/commit/966147b4f0199022576141aeef93c99bfff78972))
* stager content should be copied to clipboard automatically when possible ([0425501](https://github.com/wrighterase/emp3r0r/commit/04255015505c7e8c17b84c92758b0d95db6a985f))
* syscall.Dup2 not ready for multi-arch support ([13826d2](https://github.com/wrighterase/emp3r0r/commit/13826d23693bcf3d445a6c96cd49f956ae71df90))
* throw error if shellcode is empty ([06b6549](https://github.com/wrighterase/emp3r0r/commit/06b654961829f8cd4924848ca8448e7129201000))
* timeout connections for socks5 proxy ([1b4c6ca](https://github.com/wrighterase/emp3r0r/commit/1b4c6ca3ddac4d03206cbb536af9cec8a7e6f76c))
* timeout kill should not happen with cmds like `get` ([9ddf659](https://github.com/wrighterase/emp3r0r/commit/9ddf659d9989ecfd6b01329253987ab3ca88b384))
* tmux config: status bar scripts not working ([db9ba69](https://github.com/wrighterase/emp3r0r/commit/db9ba6990a62de520557db29ee2c64e5aa7b7441))
* tmux history length too small ([c15fe26](https://github.com/wrighterase/emp3r0r/commit/c15fe26a0151adabb113ec73df05abd41b993302))
* tmux keeps switching back to home window ([ad9d887](https://github.com/wrighterase/emp3r0r/commit/ad9d887989890037f0b818d2c1a03b40af376c92))
* too many python files, and libs not added ([7757097](https://github.com/wrighterase/emp3r0r/commit/775709722719ed84ccee0604a6be624a27d94416))
* trying to obtain output ([b90975f](https://github.com/wrighterase/emp3r0r/commit/b90975f3ef7ec71963b1e47134bc11b13710511b))
* typo ([326461c](https://github.com/wrighterase/emp3r0r/commit/326461c3b2534adef93699cd52b71438cbf80fdc))
* UDP forwarding ([c462312](https://github.com/wrighterase/emp3r0r/commit/c462312a1db770707b103ae5419d4a6cd6e5ba2c))
* unable to log to file ([55c4f7b](https://github.com/wrighterase/emp3r0r/commit/55c4f7b84d3ef7708fc2e144a87c2d92605cf2b0))
* unable to read config when started by loader.so ([9074fc4](https://github.com/wrighterase/emp3r0r/commit/9074fc4ddc8ea90851acdad8833f0007a9cc92b2))
* unable to read mac addr in kvm machines (virtio NIC) ([58ed35a](https://github.com/wrighterase/emp3r0r/commit/58ed35a412a6357d949963333ae332584d871ea1))
* unable to restore binary ([d2196c9](https://github.com/wrighterase/emp3r0r/commit/d2196c953365fc2d0ec7de1bfd1857218ee36368))
* update deps ([f4b177f](https://github.com/wrighterase/emp3r0r/commit/f4b177fe287448df7e3bd4d403bc037e6510c4f3))
* update deps ([f401df2](https://github.com/wrighterase/emp3r0r/commit/f401df25736889402d66719b2bee6588e8faf168))
* update deps ([298f87c](https://github.com/wrighterase/emp3r0r/commit/298f87c380adfa13c90c656bec5cf3e5c3517e63))
* update deps ([2aabc1e](https://github.com/wrighterase/emp3r0r/commit/2aabc1e3d70b9d5a37b3c80f0c3c452dcc44e947))
* upgrade `mholt/archiver` ([898e4a4](https://github.com/wrighterase/emp3r0r/commit/898e4a499d8558b4e016713fbdb926d4a849e11b))
* upgrade dependencies ([069484a](https://github.com/wrighterase/emp3r0r/commit/069484a7faf0b21f3e8d83717367115cc6ef87f9))
* upgrade deps ([441b978](https://github.com/wrighterase/emp3r0r/commit/441b978d39ee40a783ee275d3028d31a34287473))
* use `bash` shell when started by loader.so ([d12bda5](https://github.com/wrighterase/emp3r0r/commit/d12bda599bf01994ca2fd2e612511fb6b0a3fb8e))
* use base64 encoding for bash stager ([4d9657c](https://github.com/wrighterase/emp3r0r/commit/4d9657c5edb22c6c5474d55d38ec365601396201))
* use Go's built-in filepath sanitization ([db76751](https://github.com/wrighterase/emp3r0r/commit/db767513f4e9dbd2a12aa954e40e17426a0b58ad))
* use trusted built-in CA pool ([8ae44f0](https://github.com/wrighterase/emp3r0r/commit/8ae44f0eab5b1f9df8608da33861ddf4a711a0b6))
* UUID is all zero for Windows ([fd487d6](https://github.com/wrighterase/emp3r0r/commit/fd487d615c60b65b98b7c62f12994d497c24b9ff))
* verbose ([9786e1f](https://github.com/wrighterase/emp3r0r/commit/9786e1fdd452650f07971c45cc72344ec8c5b4e1))
* winpeas: support both ps1 and batch format ([0ebd71c](https://github.com/wrighterase/emp3r0r/commit/0ebd71c0b5d89c01b1b7a3b86d36c0f28704063d))
* word wrapping issues ([9ab1786](https://github.com/wrighterase/emp3r0r/commit/9ab178673b50af9595ab897b456d030919ae4726))
* write back agent binary so elvsh can still start ([9966d53](https://github.com/wrighterase/emp3r0r/commit/9966d531e4373fe11a5a3525892588a3159748ca))
* xz should be single-threaded ([4056da9](https://github.com/wrighterase/emp3r0r/commit/4056da9a55277a9190a97da4641f43e33cf44ae5))
